(function() {
    ...
    $.prototype.Q = function() {
        var a = I("quicksearch_button_sidebar");
        $.b.Q.call(this);
    ...
    function Bf(a) {
        ...
        a.n != "1" && (T.muteStyles != j ? f = J("input", {type: "button",id: "quicksearch_button_sidebar",value: "Search for Properties",style: "font-family:arial,sans-serif;font-size:12px;font-weight:bold;color:White;background-color:#2780e6;width:170px;height:32px;border:solid Black 1px;"}) : (f = J("input", {type: "button",id: "quicksearch_button_sidebar",value: "Search for Properties"}), 
        f.setAttribute("class", "quicksearch_button_sidebar")), d.appendChild(f));
        b = J("tr", {});
        c.appendChild(b);
        ...
        if (a.n == "1") {
            ...
            c.appendChild(i);
            d.appendChild(c);
            T.muteStyles != j ? f = J("input", {type: "button",id: "quicksearch_button_sidebar",value: "Search for Properties",style: "font-family:arial,sans-serif;font-size:12px;font-weight:bold;color:White;background-color:#2780e6;width:170px;height:32px;border:solid Black 1px;"}) : (f = J("input", {type: "button",id: "quicksearch_button_sidebar",value: "Search for Properties"}), f.setAttribute("class", "quicksearch_button_sidebar"));
            e.appendChild(f);
            b.appendChild(e)
        }
    }
    ...
    function If(a) {
        ...
        if (T.muteStyles != j)
            ...
            switch (c = J("td", {colSpan: "4"}), T.widgetType) {
                case "0":
                    c.setAttribute("class", "quicksearch_button_sidebar_cell");
                    break;
                case "1":
        ...
        b.appendChild(c);
        T.muteStyles != j ? a = J("input", {type: "button",id: "quicksearch_button_sidebar",value: "Search for Properties",style: "font-family:arial,sans-serif;font-size:12px;font-weight:bold;color:White;background-color:#2780e6;width:170px;height:32px;border:solid Black 1px;"}) : (a = J("input", {type: "button",id: "quicksearch_button_sidebar",value: "Search for Properties"}), a.setAttribute("class", "quicksearch_button_sidebar"));
        c.appendChild(a)
    }
    function Hf(a, b) {
        var c, d, e;
