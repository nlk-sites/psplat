...
function pspwp_scripts() {
	...
	$t = array( filemtime( get_stylesheet_directory() . '/style.css' ), filemtime( get_template_directory() . '/css/all_css.css'), filemtime( get_template_directory() . '/js/custom.js' ), filemtime( get_template_directory() . '/js/custom-head.js' ) );
	$t_max = max( $t );
	...
	// Styles
	wp_enqueue_style( 'pspwp-style', get_bloginfo( 'stylesheet_url' ) . '?t=' . filemtime( get_stylesheet_directory() . '/style.css' ), array(), $t_max );
	wp_enqueue_style( 'all_css', get_template_directory_uri() . '/css/all_css.css' . '?t=' . filemtime( get_template_directory() . '/css/all_css.css'), array(), $t_max );
	...
	wp_enqueue_script( 'pspwp-navigation', get_template_directory_uri() . '/js/navigation.js', array('jquery'), $vers, true );
	wp_enqueue_script( 'pspwp-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array('jquery'), $vers, true );
	...
	wp_enqueue_script( 'pspwp-custom', get_template_directory_uri() . '/js/custom.js' . '?' . filemtime( get_template_directory() . '/js/custom.js' ), array( 'jquery' ), $t_max, true );
	wp_enqueue_script( 'pspwp-custom-head', get_template_directory_uri() . '/js/custom-head.js' . '?' . filemtime( get_template_directory() . '/js/custom-head.js' ), array( 'jquery' ), $t_max, false );
