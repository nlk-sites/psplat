...
function pspwp_scripts() {
	...
	// Styles
	wp_enqueue_style( 'pspwp-style', get_bloginfo( 'stylesheet_url' ) . '?t=' . filemtime( get_stylesheet_directory() . '/style.css' ), array() );
	wp_enqueue_style( 'all_css', get_template_directory_uri() . '/css/all_css.css' . '?t=' . filemtime( get_template_directory() . '/css/all_css.css'), array() );
